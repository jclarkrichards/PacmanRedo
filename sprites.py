...
class FruitSprites(Spritesheet):
    def __init__(self, entity, level):####fruit stuff
        Spritesheet.__init__(self)
        self.entity = entity
        self.fruits = {0:(16,8), 1:(18,8), 2:(20,8), 3:(16,10), 4:(18,10), 5:(20,10)}####fruit stuff
        self.entity.image = self.getStartImage(level % len(self.fruits))###fruit stuff

    def getStartImage(self, key):#####fruuit stuff
        return self.getImage(*self.fruits[key])#####fruit stuff
